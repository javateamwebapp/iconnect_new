						...
						<div class="nano-content">
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-main">
									...
									<!--  <li>
							 <p ng-show="myVar"> 
									  <a  href="EditProfile_HRLinksServlet?Routing=EditProfileDisplay"  id="ankortag"  >
										<i class="fa fa-user"></i>
										 <span class="font-bold" id="HrLINkAppoval"></span> 
								  	<span  class="font-bold"  id="HrLINkAppoval" >Edit Profile HR Approvals</span> 
									  </a>
							  </p>
									</li>   -->
									...
									<li>
									  <a href="Hhcl_Emp_Update_By_Hr.jsp">
										<i class="fa fa-briefcase"></i>
										<span class="font-bold">Edit Profile HR Approvals</span>
									  </a>
									</li>
