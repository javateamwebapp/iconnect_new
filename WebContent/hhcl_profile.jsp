  ...
  function disableBackButton() {
					...
					<div class="container">
						<div class="row" style="padding-left:20px;">
							<div class="col-xs-12 col-sm-6 col-md-10">
								...
								<div class="f_ryt">					
 				 <button type="button" class="btn btn-info btn-lg" data-toggle="modal"  onclick="edit()"  >Edit Profile</button>
					</div>
	...
	<script type="text/javascript">
				...
				//	alert("hi");
					 ...
					 window.location.href='hhcl_edit_profile.jsp';
				//	$("#myModalBlock").show();
					//$("#profileInfo").hide();
