...
public class Serv_Mail extends HttpServlet {
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		 ...
		 * envContext.lookup("jdbc/HHCL_DESK"); con = ds.getConnection(); } catch
		 * (SQLException SQLEx) {
		 * 
		 ...
		 */	 
		final Logger logger = Logger.getLogger(Serv_Mail.class);
		...
		try {
			ConnectionpoolFilter.close(con, rs,"Serv_Mail",false);
