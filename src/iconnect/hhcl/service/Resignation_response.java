...
//		response.setContentType("text/html");
		...
		/*
		 * try { con1=(java.sql.Connection)session.getAttribute("ConnectionObj"); }
		 * catch (Exception e1) { // TODO Auto-generated catch block
		 * e1.printStackTrace(); }
		 */
        
        final Logger logger = Logger.getLogger(Resignation_response.class);
		long start = System.currentTimeMillis();
			
			con1=null; 
			try {
				try {
					con1 = ConnectionpoolFilter.Call();
			...
			logger.info("Login Servlet Main  - welcome " +con1 );
        ...
        try {
			ConnectionpoolFilter.close(con1, rs1,"Resignation_response",false);
