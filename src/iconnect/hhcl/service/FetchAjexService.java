...
public class FetchAjexService extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * try { conn=(java.sql.Connection)session.getAttribute("ConnectionObj"); }
		 * catch (Exception e1) { e1.printStackTrace(); }
		 */
		
		final Logger logger = Logger.getLogger(FetchAjexService.class);
...
//********************************
		...
		*/	
			...
			out.write(""+jason+"");
			 ...
			 try {
					ConnectionpoolFilter.close(conn, Res,"FetchAjexService",false);
